...
class Cqp(object):
    def __init__(self, window_size=6, corpus_name='PTT', time_order=-1):
        ...
        ms = [201406, 201407, 201408, 201409, 201410, 201411, 201412, 201501, 201502, 201503, 201504, 201505]
        for m in ms:
            self.freq_by_month[m] = 0

    def find(self, token, begin_time=20140601, end_time=20150531, board_list=['Gossiping']):
        if begin_time:
