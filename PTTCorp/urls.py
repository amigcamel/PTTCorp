...
urlpatterns = patterns('',
                       ...
                       url('^contact/$', intro.views.contact,
                           name='intro_contact'),
                       url('^data/$', intro.views.data, name='intro_data'),
                       url('^segmentation/$',
                           segmentation.views.main,
                           name='segmentation_main'),
                       url('^jseg/$',
                           segmentation.views.seg_jseg,
                           name='segmentation_jseg'),
                       url('^pyccs/$',
                           segmentation.views.pyccs,
                           name='segmentation_pyccs'),
                       url('^segcom/$',
                           segmentation.views.segcom,
                           name='segmentation_segcom'),
                       url('^download_res/(\w+)/$',
                           segmentation.views.download,
                           name="download_res"),
                       url('^sketch/$', sketch.views.main, name='sketch_main'),
                       url('^concordance/$',
                           sketch.views.concordance,
                           name='sketch_concordance'),
                       url('^collocation/$',
                           sketch.views.collocation,
                           name='sketch_collocation'),
                       url('^source/([a-zA-Z0-9_-]+)/(\w+)/(.+)/$',
                           sketch.views.source, name='sketch_source'),
                       url('^sentiment/$', sentiment.views.main,
                           name='sentiment_main'),
                       url('^sentipol/$',
                           sentiment.views.sentipol,
                           name='sentiment_sentipol'),
                       url('^api/$',
